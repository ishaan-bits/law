          ...
          >
            <div className="relative">
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                ...
                />
                {/* Gold Corner Accents */}
                <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-[var(--accent)]" />
                <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-[var(--accent)]" />
              </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-8 -right-8 glass-light rounded-2xl p-6 animate-float"
              >
                <div className="text-center">
                  <p className="text-4xl font-light text-[var(--accent)]">3+</p>
                  <p className="text-xs text-[var(--muted)] tracking-wider uppercase mt-1">Languages</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-8">
              {highlights.map((item, i) => (
                <motion.div
                  ...
                  className="glass-light rounded-2xl p-6 card-glow transition-all duration-500"
                >
